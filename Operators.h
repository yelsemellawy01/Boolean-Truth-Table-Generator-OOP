...
class Operators {
    ...
    Operators();
    virtual int getTruthTableValues(int a, int b); //Function to generate the truth table values for the operator that is being used in the input and return it as a string to be printed to the user
